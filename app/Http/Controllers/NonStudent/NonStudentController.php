...
namespace App\Http\Controllers\NonStudent;
...
class NonStudentController extends Controller
{
    ...
    public function index()
    {
        ...
        $search = Peserta::where('kategori_peserta', 'Non-student');
        ...
        return view('admin.non-student.index', [
    ...
    {
        return view('admin.non-student.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validated){
            return redirect('/data-non-student')->with('toast_success', 'Add Participants Successfully!');
        }else{
    ...
    {
        return view('admin.non-student.edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validated){
            return redirect('/data-non-student')->with('toast_success', 'Update Participants Successfully!');
        }else{
    ...
    public function destroy($id)
    {
        ...
        if ($deleted->delete()) {
            return redirect('/data-non-student')->with('toast_success', 'Delete Participants Successfully!');
        }else{
